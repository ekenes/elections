define(["require", "exports", "esri/layers/support/LabelClass", "esri/Color", "esri/symbols/Font", "esri/symbols", "./config", "./expressionUtils"], function (require, exports, LabelClass, Color, Font, symbols_1, config_1, expressionUtils_1) {
    ...
    //
    ///////////////////////////////////////////////////
    exports.stateChangeLabelingInfo = function () {
        return [
            ...
            new LabelClass({
                ...
                symbol: new symbols_1.TextSymbol({
                    ...
                    haloColor: new Color(config_1.haloColor),
                    haloSize: config_1.haloSize,
                    color: new Color(config_1.oColor),
                    xoffset: 20,
                    yoffset: 30
                })
            }),
    ...
    //
    ///////////////////////////////////////////////////
    exports.stateResultsLabelingInfo = function () {
        return [
            // DEMOCRAT label classes
            new LabelClass({
                minScale: 9244700,
    ...
    //
    ///////////////////////////////////////////////////
    exports.countyResultsLabelingInfo = function () {
        return [
            // DEMOCRAT label classes
            new LabelClass({
                minScale: 577791,
    ...
    //
    ///////////////////////////////////////////////////
    exports.countyChangeLabelingInfo = function () {
        return [
            // DEMOCRAT label classes
            new LabelClass({
                minScale: 577791,
